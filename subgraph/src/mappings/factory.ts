...
export function handleKeeperCreated(event: KeeperCreatedEvent): void {
  let entity = new KeeperEntity(event.params.keeperAddress.toHex());
...
export function handleMarketCreated(event: MarketCreatedEvent): void {
  let entity = new MarketEntity(event.params.marketAddress.toHex());

  // let keeperEntity: KeeperEntity | null = KeeperEntity.load(
